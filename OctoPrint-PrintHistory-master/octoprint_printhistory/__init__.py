...
class PrintHistoryPlugin(octoprint.plugin.StartupPlugin,
    ...
    @octoprint.plugin.BlueprintPlugin.route("/history/<identifier>", methods=["POST"])
    def repeatPrint(self,identifier):
        print(identifier)
        #sem dát příkaz na tisknutí objektu
        from octoprint.server import NO_CONTENT
        #print(flask.request.values[0])
        #print(NO_CONTENT)
